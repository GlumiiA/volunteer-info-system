...
P.S. Думаю можно ещё добавить время освоения и что-нибудь для людей с ограниченным зрением(бабушек, дедушек), например, ширифт увеличить. Можно ещё смену языка на англиский для инностраных пользователей, которые например только приехали, и им нужна помошь в адаптации. Надо подумать будет ли у нас адаптивный интерфейс.

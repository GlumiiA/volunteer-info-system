...
import { Card, TabView, TabPanel, DataTable, Column, Button, Dialog, InputText, Textarea } from 'primevue'
...
const getRoleName = (role) => {
  switch (role) {
    ...
    case 'ORG_REPRESENTATIVE': return 'Представитель организации'
